...
Thanks for helping test Create: Simulated Pistons.
...
- Keep changes focused and avoid new gameplay behavior unless it is discussed first.
- Do not add copied upstream assets unless their redistribution rights are clear.
- Preserve required notices for copied or adapted MIT-licensed code.
- Prefer small, reviewable changes with a short explanation of the test setup.

## Development

See [docs/development.md](docs/development.md) for local development notes and investigation history.
