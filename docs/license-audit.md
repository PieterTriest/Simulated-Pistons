...
| `src/generated/resources/assets/simulated_pistons/models/block/simulated_piston/parts/piston_link_plate.json` from `source_parts/piston_link_plate.json` | Similar to Create Simulated/Create Aeronautics bearing plate concepts | Adapted / Uncertain | Upstream asset directories: All Rights Reserved if copied or derived | Permission required if copied or derived | Needs manual review; replace or document original authorship |
| `src/main/resources/assets/simulated_pistons/models/block/simulated_piston/parts/piston_shaft_axis_y.json` | Removed unused duplicate of the generated middle shaft source | Removed | N/A | None | Removed from live assets |
